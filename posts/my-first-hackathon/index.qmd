...
![Team formation criteria](hackathon.JPG){fig-alt="Hackathon team formation criteria" fig-cap="Hackathon team formation criteria"}
...
![Hackathon Challenge](challenge.JPG){fig-alt="Hackathon Challenge" fig-cap="Hackathon Challenge"}
...
You can view our [presentation slides](hackathon_slides.pptx){target="_blank"}.

Here are some pictures from the day:

::: {.grid-2}
![Zimuzo presenting](Presentation.JPG){fig-alt="Zimuzo presenting the project during the day of the hackathon" fig-cap="Zimuzo presenting the project during the day of the hackathon"}

![Team picture](group.jpeg){fig-alt="Team picture during the presentation" fig-cap="Team picture during the presentation"}

![Whole group picture of all attendees](group2.jpg){fig-alt="Whole group picture of all attendees" fig-cap="Team picture after the presentation"}
:::
